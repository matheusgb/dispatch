---------------------------- MODULE DispatchFencing_no_epoch_guard ----------------------------
(*
...
O que este modelo cobre, mapeado para dispatch_fences / active_assignments
...
(* A lease expira: a autoridade deixa de considerar o owner atual valido.
   Equivalente a lease_until < now() no dispatch_fences. Nenhum writer
